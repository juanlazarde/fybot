...
with st.sidebar.form(key="my_form", clear_on_submit=False):
    ...
    selected_filters["breakout"]["go"] = st.checkbox(
        label="Breakout within", value=ss.DEFAULT_FILTERS["breakout"]["go"]
    )
    ...
    selected_filters["ttm_squeeze"]["go"] = st.checkbox(
        label="Post TTM Squeeze", value=ss.DEFAULT_FILTERS["ttm_squeeze"]["go"]
    )
    ...
    selected_filters["candlestick"]["go"] = st.checkbox(
        label="Candlesticks", value=ss.DEFAULT_FILTERS["candlestick"]["go"]
    )
    ...
    selected_filters["investor_reco"]["go"] = st.checkbox(
        label="Investor Recommendation", value=ss.DEFAULT_FILTERS["investor_reco"]["go"]
    )
